    ...
    <div className="relative min-h-screen flex flex-col items-center justify-between bg-gradient-to-br from-purple-50 to-blue-50 overflow-hidden">
      ...
      <div className="flex flex-col items-center justify-center flex-1 z-10 w-full px-4">
        <div className="w-full max-w-sm bg-white rounded-3xl shadow-2xl border border-gray-100 p-8 flex flex-col items-center mt-16 mb-8">
          <h2 className="text-2xl font-extrabold text-gray-900 mb-6 text-center">Create Your Account</h2>
          ...
          <form onSubmit={handleCreateAccount} className="w-full">
            ...
            <button 
              type="submit" 
              disabled={loading} 
              className="w-full py-3 rounded-xl bg-gradient-to-r from-purple-600 to-blue-600 text-white text-base font-bold shadow-lg hover:shadow-xl transform hover:scale-[1.02] transition-all duration-200 disabled:opacity-60 disabled:cursor-not-allowed disabled:transform-none"
            >
          ...
          <button
            ...
            onClick={onGoogle}
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 py-3 px-6 border-2 border-gray-200 rounded-xl font-semibold text-gray-700 bg-white hover:bg-gray-50 hover:border-gray-300 transition-all duration-200 disabled:opacity-60 disabled:cursor-not-allowed shadow-sm hover:shadow-md"
          >
          ...
          {onBack && (
            <button
              type="button"
              className="text-purple-600 hover:text-purple-700 font-medium text-sm mt-5 transition-colors duration-200"
              onClick={onBack}
              disabled={loading}
            >
              ← Back to Sign In
