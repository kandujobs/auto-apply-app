...
import { FaPlus, FaQuestionCircle, FaUser } from 'react-icons/fa';

interface EmployerTopNavProps {
  onCreate?: () => void;
  onQuestions?: () => void;
  onEdit?: () => void;
  onUserSettings?: () => void;
...
const EmployerTopNav: React.FC<EmployerTopNavProps> = ({ onCreate, onQuestions, onEdit, onUserSettings, onHome, onApplicants }) => (
  <div className="fixed top-0 left-0 w-full h-32 bg-gradient-to-r from-[#984DE0] to-[#7300FF] p-0 rounded-b-[2rem] z-10 flex flex-col items-center justify-center">
    <div className="w-fit mx-auto bg-white rounded-3xl flex justify-between items-center gap-7 py-3 px-6 shadow-lg border-2 border-gray-400 mt-4">
      {/* Create New Listing Icon */}
      <button onClick={onCreate} className="text-gray-400 hover:text-[#7300FF] transition text-2xl flex items-center" title="Create New Job Listing">
        <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" width="28" height="28">
          <g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
          <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g>
          <g id="SVGRepo_iconCarrier">
            <path d="M17.0671 2.27157C17.5 2.09228 17.9639 2 18.4324 2C18.9009 2 19.3648 2.09228 19.7977 2.27157C20.2305 2.45086 20.6238 2.71365 20.9551 3.04493C21.2864 3.37621 21.5492 3.7695 21.7285 4.20235C21.9077 4.63519 22 5.09911 22 5.56761C22 6.03611 21.9077 6.50003 21.7285 6.93288C21.5492 7.36572 21.2864 7.75901 20.9551 8.09029L20.4369 8.60845L15.3916 3.56308L15.9097 3.04493C16.241 2.71365 16.6343 2.45086 17.0671 2.27157Z" fill="currentColor"></path>
      ...
      {/* Questions Icon (middle) */}
      <button onClick={onQuestions} className="text-gray-400 hover:text-[#7300FF] text-2xl flex items-center" title="Questions">
        <svg height="28" width="28" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="currentColor">
          <g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
          <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g>
          <g id="SVGRepo_iconCarrier">
            <g>
              ...
              <path d="M228.809,406.44c-29.152,0-52.788,23.644-52.788,52.788c0,29.136,23.637,52.772,52.788,52.772 c29.136,0,52.763-23.636,52.763-52.772C281.572,430.084,257.945,406.44,228.809,406.44z"></path>
            </g>
          </g>
        </svg>
      </button>
      {/* User Settings Icon */}
      <button onClick={onUserSettings} className="text-gray-400 hover:text-[#7300FF] text-2xl flex items-center" title="User Settings">
        <svg viewBox="0 0 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg" fill="currentColor" width="28" height="28">
          <g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
          <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g>
          <g id="SVGRepo_iconCarrier">
